...
You write comprehensive pytest test suites for installkernel-wsl. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('installkernel_wsl.commands.module.some_function')
